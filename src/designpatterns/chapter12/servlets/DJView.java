package designpatterns.chapter12.servlets;

import designpatterns.chapter12.mvc.BeatModel;
...
public class DJView extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
        ...
        RequestDispatcher dispatcher = req.getRequestDispatcher("src/designpatterns/chapter12/servlets/DJView.jsp");
